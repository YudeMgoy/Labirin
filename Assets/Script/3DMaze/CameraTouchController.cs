...
public class CameraTouchController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //simpan posisi awal tp posisi real world
        ...
        //atur posisi skrg sesuai perubahan dari posisi began
        if(Input.touchCount == 1 && touch0.phase == TouchPhase.Moved)
        {
            ...
            //menggunakan lerp (linear interpolation) sbg filter
            //agar movement lbh smooth
